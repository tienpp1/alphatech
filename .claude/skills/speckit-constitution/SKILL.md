...
1. Run `python .specify/scripts/python/resolve_template.py constitution-template --json` from the repository root and parse `TEMPLATE_CONTENT` as the active template.

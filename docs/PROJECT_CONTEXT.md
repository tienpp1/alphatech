...
- Public password registration creates one inactive User and finds/creates a retail Customer, sends a signed 24-hour mailbox-verification link, and activates that same User only after the link is used. It never creates membership/role.
